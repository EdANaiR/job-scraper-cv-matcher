...
• Developed user friendly news platform with complete SEO optimization and admin panel
 ...
 TailwindCSS, Shadcn, Dynamic Routes, Cloudinar
...
"""  # CV metnini buraya yapıştır

# Selenium ile iş ilanı açıklamasını aldıktan sonra
job_description = "LinkedIn'den çektiğin ilan açıklaması buraya"

score, details = get_match_score(cv_text, job_description)

print(f"Eşleşme skoru: {score}")
print(details["match_reasoning"])
